...
import org.apache.jmeter.protocol.oauth.sampler.OAuthMessage;
import org.apache.jmeter.protocol.oauth.sampler.ParameterStyle;
import org.apache.jmeter.protocol.oauth.sampler.client.ExcerptInputStream;
    ...
    public static HttpMessage newRequest(OAuthMessage from, ParameterStyle style) throws IOException {
        ...
        case AUTHORIZATION_HEADER:
            ...
            if (others != null && !others.isEmpty()) {
                ...
                others.removeIf(stringStringEntry -> stringStringEntry.getKey().startsWith("oauth_"));
